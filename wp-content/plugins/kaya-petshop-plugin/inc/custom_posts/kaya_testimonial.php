...
{  
    ...
    add_meta_box('postimagediv', __('Testimonial Image', $petshop_plugin_name), 'post_thumbnail_meta_box', 'testimonial', 'side', 'low');  
}
...
function testimonial_slider_title( $title ){
	...
	$title = __('Enter Testimonial Name Here',$petshop_plugin_name);
	}
	return $title;
	}
