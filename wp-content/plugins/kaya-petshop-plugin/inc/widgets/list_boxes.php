<?php
// List style
 class Petshop_Custom_List_Box_Widget extends WP_Widget{

   public function __construct(){
       global $petshop_plugin_name;
       parent::__construct(  'kaya-list-box',
          __('Petshop -  List Box',$petshop_plugin_name),
          array( 'description' => __('Add list items with custom icon',$petshop_plugin_name), 'class' => 'kaya_list_box_widget' )
        );
    }
	public function widget( $args , $instance ){
		...
		echo $args['before_widget'];  ?>
			<style>
				...
				<?php } ?>
				.mid_container_wrapper_section .custom_list_box-<?php echo $list_rand ?> ul li a, .custom_list_box-<?php echo $list_rand ?> ul li{
					color: <?php echo $instance['list_color']; ?>;
				}
				.mid_container_wrapper_section .custom_list_box-<?php echo $list_rand ?> ul li a:hover, .mid_container_wrapper_section .custom_list_box-<?php echo $list_rand ?> ul li:hover {
						color: <?php echo $instance['list_hover_color']; ?>;
					}
			</style>
			<?php 
	...
	public function form( $instance ){
		...
		<div class="input-elements-wrapper">    
			...
			<p class="three_fourth">
				<label for="<?php echo $this->get_field_id('list_box') ?>"> <?php _e('List Box',$petshop_plugin_name) ?> 
				 </label>
			...
			<p class="one_fourth_last">
				<label for="<?php echo $this->get_field_id('list_color') ?>"> <?php _e('List Box List Color',$petshop_plugin_name) ?>  </label>
			...
			<p class="one_fourth">
				<label for="<?php echo $this->get_field_id('list_hover_color') ?>"> <?php _e('List Box List Hover Color',$petshop_plugin_name) ?>  </label>
				<input type="text" name="<?php echo $this->get_field_name('list_hover_color') ?>" id="<?php echo $this->get_field_id('list_hover_color') ?>" class="listbox_color_pickr" value="<?php echo esc_attr( $instance['list_hover_color'] ) ?>" />
			</p>
		</div>
		<div class="input-elements-wrapper">
			<p>
...
petshop_kaya_register_widgets('custom-list-box', __FILE__);
?>